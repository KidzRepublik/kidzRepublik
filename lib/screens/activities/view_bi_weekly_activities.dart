...
import '../consent/add_new_activity_for_class.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          Get.to(AddNewClasswiseActivity());
        },
                ...
                builder: (context, snapshot) {
                  ...
                  if (!snapshot.hasData || snapshot.data!.docs.isEmpty) {
                    return EmptyBackground(
                      title: 'No activity is registered',
                    ); // No data
                  }
                      ...
                      return InkWell(
                        ...
                        _isEnable = false;
                          ...
                          child: Padding(
                            ...
                            child: Container(
                              height: mQ.height*0.06,width: mQ.width*0.9,
                              decoration: BoxDecoration(
                                color:
                                Colors.white,
                                borderRadius: BorderRadius.circular(5), // Apply rounded corners if desired
                              ...
                              child: Column(
                                children: [
                              Container(height: mQ.height*0.015,
                                child: Row(
                                    ...
                                    children: [
                                      ...
                                      Expanded(
                                        child: Text(
                                          "${childData['title_']} ",textAlign: TextAlign.left,
                                          style: TextStyle(
                                              fontWeight: FontWeight.normal,
                                              color: Colors.blue,
                                              fontSize: 10),
                                      ...
                                      IconButton(
                                          onPressed: () {
                                            ...
                                            await confirm(context,title: Text('Delete'),textOK: Text('Yes'),textCancel: Text('No'),content: Text('Are you sure?'))?deleteDocumentFromFirestore(snapshot.data!.docs[index].id,):null;
                                            });
                              ...
                              child:
                              Text(
                                "${childData['description_']}",textAlign: TextAlign.left,
                                style: TextStyle(
                                    fontWeight: FontWeight.normal,
