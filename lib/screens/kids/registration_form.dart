  ...
  checkboxfunction(isCheckedcontroller, context, title) {
    ...
    return Row(children: [
      Checkbox(
        ...
        value: (isCheckedcontroller == 'bmothersparentalResponsibility')? registrationFormController.bmothersparentalResponsibility :
        (isCheckedcontroller == 'bfathersparentalResponsibility')? registrationFormController.bfathersparentalResponsibility  :
        (isCheckedcontroller == 'bMondayFullDay')? registrationFormController.bMondayFullDay :
        (isCheckedcontroller == 'bTuesedayFullDay')? registrationFormController.bTuesedayFullDay :
        (isCheckedcontroller == 'bWednesdayFullDay')? registrationFormController.bWednesdayFullDay :
        (isCheckedcontroller == 'bThursdayFullDay')? registrationFormController.bThursdayFullDay  :
        (isCheckedcontroller == 'bFridayFullDay')? registrationFormController.bFridayFullDay  :
        (isCheckedcontroller == 'bSaturdayFullDay')? registrationFormController.bSaturdayFullDay : false,
        onChanged: (bool? value) {
          setState(() {
            isChecked = value!;
            // (isChecked) ?
            //   controller = titlechecked             :  controller = titleunchecked;
              (isCheckedcontroller == 'bmothersparentalResponsibility')? registrationFormController.bmothersparentalResponsibility = isChecked:
              (isCheckedcontroller == 'bfathersparentalResponsibility')? registrationFormController.bfathersparentalResponsibility  = isChecked:
              (isCheckedcontroller == 'bMondayFullDay')? registrationFormController.bMondayFullDay = isChecked:
              (isCheckedcontroller == 'bTuesedayFullDay')? registrationFormController.bTuesedayFullDay = isChecked:
              (isCheckedcontroller == 'bWednesdayFullDay')? registrationFormController.bWednesdayFullDay  = isChecked:
              (isCheckedcontroller == 'bThursdayFullDay')? registrationFormController.bThursdayFullDay  = isChecked:
              (isCheckedcontroller == 'bFridayFullDay')? registrationFormController.bFridayFullDay  = isChecked:
              (isCheckedcontroller == 'bSaturdayFullDay')? registrationFormController.bSaturdayFullDay  = isChecked: null;
              }
          );}),
