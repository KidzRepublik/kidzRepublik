...
import 'package:kids_republik/utils/drop_down_function.dart';
...
bool isChecked = true;
  checkboxfunction(isCheckedcontroller, context, title) {
    ...
    return Row(children: [
      Checkbox(
        ...
        value: (isCheckedcontroller == 'bmothersparentalResponsibility')? updateRegistrationFormController.bmothersparentalResponsibility :
        (isCheckedcontroller == 'bfathersparentalResponsibility')? updateRegistrationFormController.bfathersparentalResponsibility  :
        (isCheckedcontroller == 'bMondayFullDay')? updateRegistrationFormController.bMondayFullDay :
        (isCheckedcontroller == 'bTuesedayFullDay')? updateRegistrationFormController.bTuesedayFullDay :
        (isCheckedcontroller == 'bWednesdayFullDay')? updateRegistrationFormController.bWednesdayFullDay :
        (isCheckedcontroller == 'bThursdayFullDay')? updateRegistrationFormController.bThursdayFullDay  :
        (isCheckedcontroller == 'bFridayFullDay')? updateRegistrationFormController.bFridayFullDay  :
        (isCheckedcontroller == 'bSaturdayFullDay')? updateRegistrationFormController.bSaturdayFullDay : false,
        onChanged: (bool? value) {
          setState(() {
            isChecked = value!;
            // (isChecked) ?
            //   controller = titlechecked             :  controller = titleunchecked;
              (isCheckedcontroller == 'bmothersparentalResponsibility')? updateRegistrationFormController.bmothersparentalResponsibility = isChecked:
              (isCheckedcontroller == 'bfathersparentalResponsibility')? updateRegistrationFormController.bfathersparentalResponsibility  = isChecked:
              (isCheckedcontroller == 'bMondayFullDay')? updateRegistrationFormController.bMondayFullDay = isChecked:
              (isCheckedcontroller == 'bTuesedayFullDay')? updateRegistrationFormController.bTuesedayFullDay = isChecked:
              (isCheckedcontroller == 'bWednesdayFullDay')? updateRegistrationFormController.bWednesdayFullDay  = isChecked:
              (isCheckedcontroller == 'bThursdayFullDay')? updateRegistrationFormController.bThursdayFullDay  = isChecked:
              (isCheckedcontroller == 'bFridayFullDay')? updateRegistrationFormController.bFridayFullDay  = isChecked:
              (isCheckedcontroller == 'bSaturdayFullDay')? updateRegistrationFormController.bSaturdayFullDay  = isChecked: null;
              }
          );}),
      Text(title,style: TextStyle(color: Colors.black,fontSize: 12,fontWeight: FontWeight.normal
      ),)
  ...
  Future<void> fetchdataintoformChildFunction(BuildContext context,babyId) async {
    ...
    // doc(babyId).update({
          ...
          updateRegistrationFormController.  mothersoccupation.text=snapshot.get(
      "mothersoccupation");
          updateRegistrationFormController.  mothersemployer.text=snapshot.get(
      "mothersemployer");
          updateRegistrationFormController.  mothersworkPhoneNo.text=snapshot.get(
      "mothersworkPhoneNo");
          updateRegistrationFormController.  mothersmobilePhoneNo.text=snapshot.get(
      "mothersmobilePhoneNo");
          updateRegistrationFormController.  mothersEmailAddress.text=snapshot.get(
      "mothersEmailAddress");
          updateRegistrationFormController.  mothersAddress.text=snapshot.get(
      "mothersAddress");
          updateRegistrationFormController.  mothersPostCode.text=snapshot.get(
      "mothersPostCode");
          updateRegistrationFormController.  bmothersparentalResponsibility=snapshot.get(
      "mothersparentalResponsibility");
          updateRegistrationFormController.  motherscontactrestrictions.text=snapshot.get(
      "motherscontactrestrictions");
          updateRegistrationFormController.  fathersOccupation.text=snapshot.get(
      "fathersOccupation");
          updateRegistrationFormController.  fathersEmployer.text=snapshot.get(
      "fathersEmployer");
          updateRegistrationFormController.  fathersWorkPhoneNo.text=snapshot.get(
      "fathersWorkPhoneNo");
          updateRegistrationFormController.  fathersMobileNo.text=snapshot.get(
      "fathersMobileNo");
          updateRegistrationFormController.  fathersAddress.text=snapshot.get(
      "fathersAddress");
          updateRegistrationFormController.  fathersPostCode.text=snapshot.get(
      "fathersPostCode");
          updateRegistrationFormController.  bfathersparentalResponsibility=snapshot.get(
      "fathersparentalResponsibility");
          updateRegistrationFormController.  fatherscontactrestrictions.text=snapshot.get(
      "fatherscontactrestrictions");
          updateRegistrationFormController.  otherEmergencyContactsName1.text=snapshot.get(
      "otherEmergencyContactsName1");
          updateRegistrationFormController.  otherEmergencyContactsTelephoneNo1.text=snapshot.get(
      "otherEmergencyContactsTelephoneNo1");
          updateRegistrationFormController.  otherEmergencyContactsRelationshiptoChild1.text=snapshot.get(
      "otherEmergencyContactsRelationshiptoChild1");
          updateRegistrationFormController.  otherEmergencyContactsName2.text=snapshot.get(
      "otherEmergencyContactsName2");
          updateRegistrationFormController.  otherEmergencyContactsTelephoneNo2.text=snapshot.get(
      "otherEmergencyContactsTelephoneNo2");
          updateRegistrationFormController.  otherEmergencyContactsRelationshiptoChild2.text=snapshot.get(
      "otherEmergencyContactsRelationshiptoChild2");
          updateRegistrationFormController.  MondayMorningFrom.text=snapshot.get(
      "MondayMorningFrom");
          updateRegistrationFormController.  MondayMorningTo.text=snapshot.get(
      "MondayMorningTo");
          updateRegistrationFormController.  MondayEveneingFrom.text=snapshot.get(
      "MondayEveneingFrom");
          updateRegistrationFormController.  MondayEveneingTo.text=snapshot.get(
      "MondayEveneingTo");
          updateRegistrationFormController.  bMondayFullDay=snapshot.get(
      "MondayFullDay");
          updateRegistrationFormController.  TuesdayMorningFrom.text=snapshot.get(
      "TuesdayMorningFrom");
          updateRegistrationFormController.  TuesdayMorningTo.text=snapshot.get(
      "TuesdayMorningTo");
          updateRegistrationFormController.  TuesdayEveningFrom.text=snapshot.get(
      "TuesdayEveningFrom");
          updateRegistrationFormController.  TuesdayEveneingTo.text=snapshot.get(
      "TuesdayEveneingTo");
          updateRegistrationFormController.  bTuesedayFullDay=snapshot.get(
      "TuesdayFullDay");
          updateRegistrationFormController.  WednesdayMorningFrom.text=snapshot.get(
      "WednesdayMorningFrom");
          updateRegistrationFormController.  WednesdayMorningTo.text=snapshot.get(
      "WednesdayMorningTo");
          updateRegistrationFormController.  WednesdayEveneingFrom.text=snapshot.get(
      "WednesdayEveneingFrom");
          updateRegistrationFormController.  WednesdayEveneingTo.text=snapshot.get(
      "WednesdayEveneingTo");
          updateRegistrationFormController.  bWednesdayFullDay=snapshot.get(
      "WednesdayFullDay");
          updateRegistrationFormController.  ThursdayMorningFrom.text=snapshot.get(
      "ThursdayMorningFrom");
          updateRegistrationFormController.  ThursdayMorningTo.text=snapshot.get(
      "ThursdayMorningTo");
          updateRegistrationFormController.  ThursdayEveneingFrom.text=snapshot.get(
      "ThursdayEveneingFrom");
          updateRegistrationFormController.  ThursdayEveneingTo.text=snapshot.get(
      "ThursdayEveneingTo");
          updateRegistrationFormController.  bThursdayFullDay=snapshot.get(
      "ThursdayFullDay");
          updateRegistrationFormController.  FridayMorningFrom.text=snapshot.get(
      "FridayMorningFrom");
          updateRegistrationFormController.  FridayMorningTo.text=snapshot.get(
      "FridayMorningTo");
          updateRegistrationFormController.  FridayEveneingFrom.text=snapshot.get(
      "FridayEveneingFrom");
          updateRegistrationFormController.  FridayEveneingTo.text=snapshot.get(
      "FridayEveneingTo");
          updateRegistrationFormController.  bFridayFullDay=snapshot.get(
      "FridayFullDay");
          updateRegistrationFormController.  SaturdayMorningFrom.text=snapshot.get(
      "SaturdayMorningFrom");
          updateRegistrationFormController.  SaturdayMorningTo.text=snapshot.get(
      "SaturdayMorningTo");
          updateRegistrationFormController.  SaturdayEveneingFrom.text=snapshot.get(
      "SaturdayEveneingFrom");
          updateRegistrationFormController.  SaturdayEveneingTo.text=snapshot.get(
      "SaturdayEveneingTo");
          updateRegistrationFormController.  bSaturdayFullDay=snapshot.get(
      "SaturdayFullDay");
          updateRegistrationFormController.  doctorsName.text=snapshot.get(
      "doctorsName");
