...
bool deleteionLoading = false;
  ...
  floatingActionButton:
        IconButton(
          ...
          icon: Icon(Icons.add)
          // Image.asset('assets/manager/registration.png',
          //     width: mQ.width * 0.29),
                        ...
                        decoration: BoxDecoration(
                          ...
                          image: DecorationImage(alignment: FractionalOffset.topCenter,
                            ...
                            itemBuilder:
                                (BuildContext
                            context) {
                              return (role_ == "Principal")? classes_.map(
                                      (String item) {
                            ...
                            selectedItem) async {
                              ...
                              (role_ == "Principal")? await confirm(title: Text("Are You sure to proceed"), textOK: Text('Yes'),textCancel: Text('No'),context)?
                              {selectedItem == 'Delete'?await confirm(title: Text("Are You sure to Delete",style: TextStyle(color: Colors.red[900])), textOK: Text('Yes'),textCancel: Text('No'),context)?deleteDocumentFromFirestore(snapshot.data!.docs[position].id):null:
