...
class _ParentDailySheetScreenState extends State<ParentDailySheetScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return
    Padding(
            padding: EdgeInsets.only(left: mQ.width*0.005),
            child: Column(
                children: [
              Container(
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return InkWell(
                          ...
                          child:
                          (widget.boxheading == 'Checked In')?(activityData['Activity'] == 'Checked In'|| activityData['Activity'] == 'Absent')?
                          Expanded(
                            child: Text('${activityData['Activity']}:${activityData['time_']} ',
                              ...
                              :Expanded(child: Container()): (widget.boxheading == 'Checked Out')?
                          ...
                          Expanded(
                            child: Text(' ${activityData['time_']} ',
                              ...
                              // (widget.subject == 'Attendance') ? printattendance(activityData, mQ,widget.boxheading):
                              (widget.subject == 'Food') ? printfeeding(activityData, mQ):
                              (widget.subject == 'Toilet') ? printtoilet(activityData, mQ):
                              (widget.subject == 'Fluids') ? printfluids(activityData, mQ):
                              (widget.subject == 'Sleep') ? printsleep(activityData, mQ):
                              (widget.subject == 'Mood') ? printmood(activityData, mQ):
                              (widget.subject == 'Health') ? printhealth(activityData, mQ):
                              (widget.subject == 'Activity') ? printactivity(activityData, mQ):
                              (widget.subject == 'Notes') ? printnotes(activityData, mQ):
  ...
  late bool _isEnable;
  showParentDialog(documentId, activity_, description, subject, class_, mQ,
