                                                ...
                                                style: TextStyle(
                                                  ...
                                                  children: [
                                                    ...
                                                    Expanded(
                                                      child: IconButton(
                                                          onPressed: () async {
                                                            (role_ == "Principal")?await confirm(title: Text("Are You sure to Delete",style: TextStyle(color: Colors.red[900])), textOK: Text('Yes'),textCancel: Text('No'),context)?deleteDocumentFromFirestore(snapshot.data!.docs[index].id):null:Navigator.of(context).pop;
