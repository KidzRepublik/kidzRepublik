...
final classes_  =<String> [ 'Select class', 'Infant', 'Todler', 'Kinder Garten - I', 'Kinder Garten - II', 'Play Group - I'];
              ...
              return ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return Padding(
                    ...
                    child: Container(height: mQ.height*0.07,
                      ...
                      child: Column(
                        children: [
                          Container(height: mQ.height*0.04,
                                    ...
                                    children: [
                                      Expanded(
                                        child: PopupMenuButton<String>(
                                          ...
                                          onSelected: (String
                                          selectedItem) async {
                                            await confirm(title: Text("Are You sure to proceed"), textOK: Text('Yes'),textCancel: Text('No'),context)?
                                            collectionReference.doc(snapshot.data!.docs[index].id).update({"class": selectedItem}):Null;

                                          },
                                        child:
                                        Container(height: mQ.height*0.03,
                                          child:
                          ...
                          classSummary(mQ, userData['class'])
                        ],
                      ),
                    ),
                  );
...
Widget classSummary(mQ,class_){
  ...
  return Padding(
    ...
    children: [
    Expanded(child: Text('Strength: ${classData['strength_']}',style: TextStyle(fontSize: 10,color: Colors.blue[900]),)),
    Expanded(child: Text('Present: ${classData['present_']}',style: TextStyle(fontSize: 10,color: Colors.green[900]),)),
    Expanded(child:  Text('Absent: ${classData['absent_']}',style: TextStyle(fontSize: 10,color: Colors.red[900]),)),
    ],
    ),
  );
