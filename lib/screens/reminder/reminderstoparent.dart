...
mainAxisAlignment: MainAxisAlignment.center,
                        ...
                        children: [
                          Container(
                              ...
                              height: mQ.height*0.07,width: mQ.width*0.95,
                                                ...
                                                : Row(
                                                    ...
                                                    children: [
                                                      ...
                                                      Expanded(
                                                        child: IconButton(
                                                            onPressed: () async {
                                                              (role_ == "Principal")?await confirm(title: Text("Are You sure to Delete",style: TextStyle(color: Colors.red[900])), textOK: Text('Yes'),textCancel: Text('No'),context)?deleteDocumentFromFirestore(snapshot.data!.docs[index].id):null:Navigator.pop(context);
              ...
              child: Column(mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      Text(
                        'Reminder Statement', textAlign: TextAlign.left,
                        style: TextStyle(
                            fontSize: 12, fontWeight: FontWeight.normal),
                      ),
                      TextField(
