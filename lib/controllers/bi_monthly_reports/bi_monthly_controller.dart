...
class BiMonthlyController extends GetxController {
  ...
  CollectionReference collectionReferencectivity = FirebaseFirestore.instance
      .collection('Activity');
  ...
  addActivityfunction(BuildContext context,childId, subject,
      activity, descriptions, imageUrl, activitytime_,categorys) async {
    // currentTime.value = activitytime_;
    isLoading.value = true;
    print (subject);
    try {
      await collectionReferencectivity
          .add({
        "id": childId,
        "Subject": subject,
        "Activity": activity,
        ...
        "image_": imageUrl,
        "status_": (categorys == 'BiWeekly')?'':"New",
        "photostatus_":(subject == 'Food'||subject == 'Fluids'||subject == 'Activity'||subject == 'Health')? "New" : '',
        "category_": categorys,
